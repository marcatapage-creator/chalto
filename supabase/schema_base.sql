...
\restrict 7p9q1fnqm41RSpnlezd4LvcU332YOo7Ok0JbflJwWwLMfULcHfbMEVuzl27exFq
...
--
-- Name: objects Authenticated can read documents; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated can read documents" ON storage.objects FOR SELECT USING (((bucket_id = 'documents'::text) AND (auth.role() = 'authenticated'::text)));
...
CREATE POLICY "Authenticated users can upload" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'documents'::text) AND (auth.role() = 'authenticated'::text)));
...
CREATE POLICY "Users can delete own files" ON storage.objects FOR DELETE USING (((bucket_id = 'documents'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects Users can delete their logo; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can delete their logo" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'logos'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Users can update their logo; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can update their logo" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'logos'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Users can upload their logo; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can upload their logo" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'logos'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));
...
--
-- Name: objects documents_delete_own; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects documents_insert_own; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects documents_select_own; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects logos_owner_delete; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY logos_owner_delete ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'logos'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects logos_owner_insert; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY logos_owner_insert ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'logos'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects logos_owner_select; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY logos_owner_select ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'logos'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects logos_owner_update; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY logos_owner_update ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'logos'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));
