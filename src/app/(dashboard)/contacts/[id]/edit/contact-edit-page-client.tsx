...
interface ContactEditPageClientProps {
  contact: Contact
  professions: Profession[]
}

export function ContactEditPageClient({ contact, professions }: ContactEditPageClientProps) {
  ...
  return (
    ...
    >
      <div className="shrink-0 border-b px-4 py-3 flex items-center gap-3 bg-popover">
        ...
        <div>
          <p className="text-sm font-medium">Modifier {contact.name}</p>
