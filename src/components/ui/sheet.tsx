    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "data-[side=bottom]:data-[state=closed]:animate-out data-[side=bottom]:data-[state=closed]:slide-out-to-bottom-[100%] data-[side=bottom]:data-[state=closed]:duration-300 data-[side=bottom]:data-[state=closed]:[animation-timing-function:cubic-bezier(0.32,0.72,0,1)]",
          className
        )}
        {...props}
      >
